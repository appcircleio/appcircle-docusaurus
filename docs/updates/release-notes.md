...
### :muscle: Improvement
- Added the feature that [LDAP and SSO](../account/sso-and-ldap-login/sso-ldap-login.md) settings  can be made once and all sub-organizations can use this setting. <CloudBadge/> <SelfHostedBadge/>
...
- [SSO and LDAP Login](../account/sso-and-ldap-login/sso-ldap-login.md) added to Testing Distribution. <CloudBadge/> <SelfHostedBadge/>
