...
The guidelines detailed in the **Custom Script from Git** documentation for [Build Workflow](/build-integrations) also apply to the Custom Script in [Publish](/publish-to-stores-module). Therefore, this document will not repeat those details. For comprehensive information about the **Custom Script from Git** step, please visit the link below:

<RunnerUsage />

<ContentRef url="/build-integrations/common-integrations/custom-script-from-git">
