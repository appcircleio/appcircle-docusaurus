---
title: Appcircle Login Single Sign-On (SSO) Providers Configuration
...
6. Additionally, enter a **Display Name** for your organization. This Display Name is especially required for SAML configurations.
...
4. Once created, take note of the **Client ID** and **Client Secret**, which will be needed later.
...
3. Download the OpenID configuration JSON file from Auth0.
This configuration file will be used in the next step to configure Appcircle.
...
4. Complete any additional configuration settings in Appcircle as required.
...
This section provides an overview of how to test and verify your SSO configuration for different identity providers.

### 5.1 Overview of Testing Process

Ensure the SSO configuration is complete by logging out of your account and following the provider-specific testing steps provided in the configuration sections.

### 5.2 Key Testing Points

- **Provider-Specific Instructions:** For detailed testing steps, refer to the "Test the Integration" step within each provider’s section. 
- **Verification:** Confirm account linking and successful login as shown in the respective screenshots.
...
### 6.8 Troubleshooting for Keycloak (OpenID Connect)
...
### 6.9 Troubleshooting for Keycloak (SAML)
