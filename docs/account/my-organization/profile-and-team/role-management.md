...
Please use [**Appcircle Login**](/account/my-organization/integrations/authentications/sso-providers-configuration) for **LDAP** and **SSO** integration when logging into Appcircle.
