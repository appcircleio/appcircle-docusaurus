...
slug: /build-integrations/flutter-specific-integrations/flutter-build-for-web
...
|-------------------------------------------------|-------------------------------------------------|
| [**Git Clone**](/build-integrations/common-integrations/git-clone) | This step clones your project from the connected Git provider and creates the `$AC_REPOSITORY_DIR` variable, which defaults to `$AC_FLUTTER_PROJECT_DIR`. |
| [**Flutter Install**](/build-integrations/flutter-specific-integrations/flutter-install) | This step installs the [Flutter SDK](https://flutter-ko.dev/development/tools/sdk/releases). If no version is specified, it installs the latest **stable** version. |
...
- Then, add an [Upload to Amazon S3 step to your workflow](/build-integrations/common-integrations/upload-files-to-amazon-s3) and configure it to receive the web app artifact as the input of the step.
