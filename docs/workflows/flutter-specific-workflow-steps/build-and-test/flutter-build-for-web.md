...
|-------------------------------------------------|-------------------------------------------------|
| [**Git Clone**](../../common-workflow-steps/build-and-test/git-clone) | This step clones your project from the connected Git provider and creates the `$AC_REPOSITORY_DIR` variable, which defaults to `$AC_FLUTTER_PROJECT_DIR`. |
...
- Then, add an [Upload to Amazon S3 step to your workflow](../../common-workflow-steps/build-and-test/upload-files-to-amazon-s3) and configure it to receive the web app artifact as the input of the step.
