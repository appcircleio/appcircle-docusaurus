...
slug: /build-integrations/ios-specific-integrations/audit-permission-change
...
|-------------------------------------------------|-------------------------------------------------|
| [**Git Clone**](/build-integrations/common-integrations/git-clone) | You need to clone the repository to start the **Audit Permission Changes** step. After cloning, the system installs CocoaPods. After this step works, the variable `$AC_REPOSITORY_DIR` will be created. |
