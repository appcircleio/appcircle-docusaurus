...
This step is used to specify the Xcode version to be used during the build process. All available versions of Xcode can be seen in the [Configuration](/build/build-process-management#profile-configuration) tab.
...
Please **don't forget** to select the **Xcode version** from [Configuration](/build/build-process-management#profile-configuration) first.
...
- To select an Xcode version, open [Configuration](/build/build-process-management#profile-configuration) in the build profile.
