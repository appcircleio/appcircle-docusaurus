...
slug: /build-integrations/ios-specific-integrations/browserstack-app-automation
...
|-------------------------------------------------|-------------------------------------------------|
| [**Xcodebuild for Testing**](/build-integrations/ios-specific-integrations/xcodebuild-for-testing) | After the [**Xcodebuild for Testing**](/build-integrations/ios-specific-integrations/xcodebuild-for-testing) step runs, the test IPA paths (`$AC_TEST_IPA_PATH` and `$AC_UITESTS_RUNNER_PATH`) will be created automatically. So that the **BrowserStack** component depends on these paths. |
...
| `$AC_TEST_IPA_PATH`              | Full path of the IPA file. This path will automatically generate in [**Xcodebuild for Testing**](/build-integrations/ios-specific-integrations/xcodebuild-for-testing) step.| Required |
| `$AC_UITESTS_RUNNER_PATH`             | Full path of the *-Runner.app. This path will automatically generate in [**Xcodebuild for Testing**](/build-integrations/ios-specific-integrations/xcodebuild-for-testing) step. | Required |
