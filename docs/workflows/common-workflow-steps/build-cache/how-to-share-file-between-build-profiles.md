...
slug: /build-integrations/common-integrations/build-cache/how-to-share-file-between-build-profiles
...
This simple example will use our [**CocoaPods**](https://cocoapods.org/) files in different build profiles. If you intend to use a cache other than dependencies, please refer to the documentation for the [**Cache Push**](/build-integrations/common-integrations/build-cache/cache-push) component.

:::

:::caution

To share cache between Build Profiles, the [**Cache Pull**](/build-integrations/common-integrations/build-cache/cache-pull) component must be added to the related pipeline.
...
1. Firstly, the caching of CocoaPods files is initiated in the **`Appcircle Team`** build profile. These files will subsequently be utilized in the **`Appcircle Team 2`** build profile. To accomplish this, the [**Cache Push**](/build-integrations/common-integrations/build-cache/cache-push) step should be incorporated into the workflow after the **CocoaPods Install** step in the initial build profile.
...
When sharing cache files between **Build Profiles**, please make sure that you spell your build profile ID and branch names correctly and use the [**Cache Push**](/build-integrations/common-integrations/build-cache/cache-push) and [**Cache Pull**](/build-integrations/common-integrations/build-cache/cache-pull) steps correctly in each profile. 
