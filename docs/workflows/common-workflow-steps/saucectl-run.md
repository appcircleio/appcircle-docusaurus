...
To access all saved artifacts, go to the [Download Artifacts](/build/build-process-management#download-artifacts) section in Appcircle at the end of the build log.