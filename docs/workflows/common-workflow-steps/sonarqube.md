...
:::caution
Ensure that the test result path provided to **SonarQube** as a property matches the test result path generated by the [**Android Unit Tests**](https://github.com/appcircleio/appcircle-android-unit-test-component.git) step, and direct the output to that location.
:::
