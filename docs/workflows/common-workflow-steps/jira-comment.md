...
| `$AC_JIRA_ISSUE`              | The ID or key of the issue. Refer to the [documentation](/workflows/common-workflow-steps/jira-comment) for instructions on extracting this information from branch names or commit messages. | Required |
