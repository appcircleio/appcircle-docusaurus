...
slug: /build-integrations/android-specific-integrations/android-sign
...
To share the signed apps created as an output of this step or to view them on the [**Download Artifacts**](/build-integrations/common-integrations/export-build-artifacts#download-exported-artifacts) page, please ensure that the [**Export Build Artifacts**](/build-integrations/common-integrations/export-build-artifacts) step is included in your workflow after this step.
