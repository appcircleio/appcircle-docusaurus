---
title: Saucectl Run for Android
...
tags: [saucectl, saucectl run, sauce labs, test, android test, emulator, device test, automation]
---

import Screenshot from '@site/src/components/Screenshot';

# Saucectl Run for Android
...
Before executing the **Saucectl Run for Android** workflow step, you need to add the following prerequisite step on the workflow:
