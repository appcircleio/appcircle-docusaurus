...
For LDAP configuration and mapping, please refer to the [LDAP](/account/my-organization/integrations/authentications/distribution-ldap-authentication) documentation.
