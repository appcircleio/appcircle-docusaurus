...
Our macOS runners have Xcode versions 26.3.x, 26.2.x, 26.1.x, 26.0.x, 16.4.x, 16.3.x, 16.2.x, 16.1.x, 16.0.x, 15.4.x, 15.3.x, 15.2.x, 15.1.x, 15.0.x, 14.3.x available.
...
| Package            | macOS Sonoma | macOS Sequoia `15.4.1` | macOS Sequoia `15.6.1` |
| ------------------ | -------------- | -------------- | -------------- |
| Bash               | 3.2.57         | 3.2.57 | 3.2.57 |
| Bundle             | 2.4.19         | 2.4.19 | 2.7.2 |
| Carthage           | 0.39.1         | 0.40.0 | 0.40.0 |
| Curl               | 8.6.0          | 8.7.1 | 8.7.1 |
| Homebrew           | 4.3.5          | 4.5.1 | 4.6.16 |
| Java (OpenJDK)     | 17.0.9         | 17.0.9 | 17.0.9 |
| Gem                | 3.4.19         | 3.4.19 | 3.4.19 |
| Fastlane           | 2.220.0        | 2.227.2 | 2.228.0 |
| Git                | 2.45.2         | 2.49.0 | 2.51.0 |
| Git LFS            | 3.5.1          | 3.6.1 | 3.7.0 |
| Gzip (Apple)       | 430.100.5      | 457.100.3 | 457.140.3 |
| LibreSSL (OpenSSL) | 3.3.6          | 3.3.6 | 3.3.6 |
| ImageMagick        | 7.1.1-33       | 7.1.1-47 | 7.1.2-5 |
| Maven              | 3.9.7          | 3.9.9 | 3.9.11 |
| N                  | 9.2.3          | 10.1.0 | 10.2.0 |
| Node               | 18.20.3        | 18.20.8 | 18.20.8 |
| Npm                | 10.7.0         | 10.8.2 | 10.8.2 |
| Perl               | 5.34.1         | 5.34.1 | 5.34.1 |
| Pod                | 1.15.2         | 1.16.2 | 1.16.2 |
| Pip                | 24.0           | 25.0.1 | 25.2 |
| Python             | 3.12.3         | 3.13.3 | 3.14.0 |
| Rake               | 13.0.6         | 13.0.6 | 13.3.0 |
| Ruby               | 3.2.3          | 3.2.3 | 3.2.3 |
| Rbenv              | 1.2.0          | 1.3.2 | 1.3.2 |
| Sdkman             | 5.18.2         | 5.19.0 | 5.20.0 |
| Slather            | 2.8.0          | 2.8.5 | 2.8.5 |
| Unzip              | 6.00           | 6.00 | 6.00 |
| Xcodeproj          | 1.27.0         | 1.27.0 | 1.27.0 |
