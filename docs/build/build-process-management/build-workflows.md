...
Appcircle will build your application with the steps defined in the [workflow](https://github.com/appcircleio/appcircle-workflow-components). Steps will be executed in order from the top to the bottom.
