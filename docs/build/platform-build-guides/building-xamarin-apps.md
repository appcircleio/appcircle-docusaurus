...
Keep in mind that, in order to use iOS Signing Identities in the build pipeline, the [workflow](https://github.com/appcircleio/appcircle-workflow-components) should also have an [**Install Certificates & Profiles**](/build-integrations/ios-specific-integrations/install-certificates-provisions) step.
...
Keep in mind that, in order to switch to the selected Xcode version in the build pipeline, the [workflow](https://github.com/appcircleio/appcircle-workflow-components) should also have an [**Xcode Select**](/build-integrations/ios-specific-integrations/xcode-select) step.
...
**6.** In your [workflow](https://github.com/appcircleio/appcircle-workflow-components), use the below custom script as a replacement of the default **Xcodebuild for Devices** step. Remove the **CocoaPods Install** and **Increment Build and Version Number** steps from your workflow.
...
Keep in mind that, in order to use Android Signing Identities in the build pipeline, the [workflow](https://github.com/appcircleio/appcircle-workflow-components) should also have an [**Android Sign**](/build-integrations/android-specific-integrations/android-sign) step.
...
**6.** In your [workflow](https://github.com/appcircleio/appcircle-workflow-components), use the below **Custom Script** as a replacement of the default **Android Build** step. Remove the **Android App Post-Processor** and **Increment Build and Version Number** steps from your workflow.
