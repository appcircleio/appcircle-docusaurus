...
**6.** In your [workflow](https://github.com/appcircleio/appcircle-workflow-components), use the below custom script as a replacement for the default **Xcodebuild for Devices** step.
...
**6.** In your [workflow](https://github.com/appcircleio/appcircle-workflow-components), use the below **Custom Script** as a replacement of the default **Android Build** step.
...
- Ready to release? Then [Publish](/publish-to-stores-module) the .NET MAUI app to public stores such as Google Play, App Store, or Huawei AppGallery.
