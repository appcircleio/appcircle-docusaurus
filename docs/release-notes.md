...
- Users now have the capability to be redirected to their desired locations upon clicking on [Okta applications](/account/my-organization/integrations/authentications), enhancing navigation efficiency and user experience within the system. <CloudBadge/> <SelfHostedBadge/>
...
- Added the feature that [LDAP](/account/my-organization/integrations/authentications) and [SSO](/account/my-organization/integrations/authentications) settings can be made once and all sub-organizations can use this setting. <CloudBadge/> <SelfHostedBadge/>
...
- [SSO](/account/my-organization/integrations/authentications) and [LDAP](/account/my-organization/integrations/authentications) Login added to Testing Distribution. <CloudBadge/> <SelfHostedBadge/>
