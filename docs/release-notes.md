...
- The Build Module has been updated to enforce uniqueness for all [workflow](https://github.com/appcircleio/appcircle-workflow-components) step names. This enhancement was implemented to prevent potential conflicts caused by duplicate names, thereby improving the clarity and reliability of build workflows. <BuildBadge/> <CloudBadge/> <SelfHostedBadge/>
