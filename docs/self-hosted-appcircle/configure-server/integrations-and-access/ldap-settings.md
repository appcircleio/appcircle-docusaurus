...
Ensure that multiple LDAP settings are properly configured on your Appcircle server's [integration settings](/account/my-organization/integrations/authentication/store-and-distribution-ldap-authentication).
