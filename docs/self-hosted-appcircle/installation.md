...
```bash
curl -o appcircle-server-linux-x64-1.0.1.zip -L https://cdn.appcircle.io/self-hosted/appcircle/appcircle-server-linux-x64-1.0.1.zip
```

Extract self-hosted appcircle package into folder.

```bash
unzip -o -u appcircle-server-linux-x64-1.0.1.zip -d appcircle-server
```
